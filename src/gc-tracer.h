...
// GCTracer的主要作用是为每一个garbage collector收集数据。
...
#undef DEFINE_SCOPE
  ...
  // 采样并累计自上次gc申请的字节数。Sample and accumulate bytes allocated since the last GC.
